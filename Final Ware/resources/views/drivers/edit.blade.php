    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('drivers.update', $driver->id) }}" method="POST" novalidate class="needs-validation">
                        @csrf
                        @method('PUT')
...
@enderror
       ...
       placeholder="e.g., TM40 12345678901" required maxlength="20">
...
@enderror
       ...
       id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', isset($driver) ? $driver->date_of_birth->format('Y-m-d') : '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('joined_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('joined_date', $driver->joined_date->format('Y-m-d')) }}"
                                           min="{{ old('date_of_birth', $driver->date_of_birth->format('Y-m-d')) }}" required>
                                    @error('joined_date')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
