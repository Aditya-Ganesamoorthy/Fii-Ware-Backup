            ...
            <div class="card card-primary card-outline">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form method="GET" action="{{ route('reports.purchase') }}" class="form-inline">
                ...
                <div class="card-body">
                    <form action="{{ route('reports.purchase.filter') }}" method="GET" class="form-inline mb-4">
...
<script>
    $(document).ready(function() {
        ...
        $('#exportBtn').click(function() {
            ...
            window.location.href = "{{ url('reports/purchase/export') }}?from_date=" + fromDate + "&to_date=" + toDate + "&per_page=" + perPage;
        });
    });
</script>
@endsection
