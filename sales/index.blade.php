...
<div class="container-fluid"
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 style="color: #555555;">All Sales</h3>
        @if(in_array('sales.create', $allowedRoutes))
            <a href="{{ route('sales.create') }}" class="btn btn-success btn-sm" style="background-color: #FFEB00; color: #555555;"> New Sale</a>
        @endif
    </div>

    {{-- 🔍 Vendor Filter --}}
    <div class="mb-4">
        <label for="vendor_filter" style="color: #555555;">Filter by Vendor</label> 
    ...
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-header" style="background-color: #FFEB00; color: #555555;">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0">Sales Records</h3>
                <form method="GET" action="{{ route('sales.index') }}" class="form-inline">
                    <label for="per_page" style="color: #555555;">Rows per page</label>
